...
///*!
// * Indicates if any action command is received
// */
//static bool RxAnyActionCmd = false;
...
{
	if(TxDutyCycleImmediately == false)
	{
	    AppDataSize = 5;
	    AppData[0] = 0x48;
	    AppData[1] = 0x65;
...
static void McpsIndication( McpsIndication_t *mcpsIndication )
{
    ...
    if( mcpsIndication->RxData == true )
	    {// if the data is available
			...
			printf("\r\n");
			if(mcpsIndication->Buffer[0] == 0xAB && mcpsIndication->Buffer[1] == 0xCD)
			{
				printf("relay on\r\n");
			...
			else if(mcpsIndication->Buffer[0] == 0xDC && mcpsIndication->Buffer[1] == 0xBA)
			{
				printf("relay off\r\n");
	...
	// Define TxDutyCycleImmediately according to whether an action command is received
//	if(RxAnyActionCmd == true)
//	{
//		TxDutyCycleImmediately = true; // send data immediately
//		RxAnyActionCmd = false;
//	}
//	else
//	{
